...
//set_attack_value(AT_FAIR, AG_SPRITE, asset_get("gus_ftilt_spr"));
set_attack_value(AT_FAIR, AG_NUM_WINDOWS, 4);
set_attack_value(AT_FAIR, AG_HAS_LANDING_LAG, 3);
set_attack_value(AT_FAIR, AG_OFF_LEDGE, 1);
//set_attack_value(AT_FAIR, AG_AIR_SPRITE, asset_get("gus_fair_spr"));
//set_attack_value(AT_FAIR, AG_HURTBOX_SPRITE, asset_get("gus_fair_hurt"));
...
set_window_value(AT_FAIR, 2, AG_WINDOW_SFX, asset_get("sfx_dust_knuckle"));
set_window_value(AT_FAIR, 2, AG_WINDOW_SFX_FRAME, 0);


set_window_value(AT_FAIR, 3, AG_WINDOW_TYPE, 2);
...
set_window_value(AT_FAIR, 3, AG_WINDOW_HSPEED_TYPE, 2);
...
set_window_value(AT_FAIR, 4, AG_WINDOW_HAS_WHIFFLAG, 4);
...
set_window_value(AT_FAIR, 5, AG_WINDOW_HSPEED, 10);
set_window_value(AT_FAIR, 5, AG_WINDOW_VSPEED, 0);
set_window_value(AT_FAIR, 5, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_FAIR, 5, AG_WINDOW_VSPEED_TYPE, 0);
...
set_window_value(AT_FAIR, 5, AG_WINDOW_SFX, asset_get("sfx_dust_knuckle"));
set_window_value(AT_FAIR, 5, AG_WINDOW_SFX_FRAME, 0);


set_window_value(AT_FAIR, 6, AG_WINDOW_TYPE, 2);
...
set_window_value(AT_FAIR, 6, AG_WINDOW_HSPEED, 0);
set_window_value(AT_FAIR, 6, AG_WINDOW_VSPEED, 0);
set_window_value(AT_FAIR, 6, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_FAIR, 6, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_FAIR, 6, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_FAIR, 6, AG_WINDOW_CUSTOM_AIR_FRICTION, 0);
set_window_value(AT_FAIR, 6, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0);
set_window_value(AT_FAIR, 6, AG_WINDOW_HITPAUSE_FRAME, 0);
set_window_value(AT_FAIR, 6, 27, .1);
set_window_value(AT_FAIR, 6, 28, 0);


set_window_value(AT_FAIR, 7, AG_WINDOW_TYPE, 3);
...
set_window_value(AT_FAIR, 7, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_FAIR, 7, AG_WINDOW_CUSTOM_AIR_FRICTION, 0);
set_window_value(AT_FAIR, 7, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0);
set_window_value(AT_FAIR, 7, AG_WINDOW_HAS_WHIFFLAG, 4);
set_window_value(AT_FAIR, 7, AG_WINDOW_CANCEL_TYPE, 0);
set_window_value(AT_FAIR, 7, AG_WINDOW_CANCEL_FRAME, 0);
...
set_hitbox_value(temp_attack, temp_num, HG_HIT_LOCKOUT, 3);
