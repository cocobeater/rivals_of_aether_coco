...
//set_attack_value(AT_USTRONG_2, AG_SPRITE, asset_get("gus_nspecial2_spr"));
...
//set_attack_value(AT_USTRONG_2, AG_AIR_SPRITE, asset_get("gus_nspecial2_spr"));
set_attack_value(AT_USTRONG_2, 14, 1);
set_attack_value(AT_USTRONG_2, 15, 120);
//set_attack_value(AT_USTRONG_2, AG_HURTBOX_SPRITE, asset_get("gus_nspecial2_hurt"));
set_window_value(AT_USTRONG_2, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_USTRONG_2, 1, AG_WINDOW_LENGTH, 15);
set_window_value(AT_USTRONG_2, 1, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(AT_USTRONG_2, 1, AG_WINDOW_ANIM_FRAME_START, 0);
set_window_value(AT_USTRONG_2, 1, AG_WINDOW_HAS_CUSTOM_FRICTION, 0);
set_window_value(AT_USTRONG_2, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, .3);
...
set_window_value(AT_USTRONG_2, 1, AG_WINDOW_SFX_FRAME, 10);


set_window_value(AT_USTRONG_2, 2, AG_WINDOW_TYPE, 2);
...
set_window_value(AT_USTRONG_2, 2, AG_WINDOW_HAS_CUSTOM_FRICTION, 0);
...
set_window_value(AT_USTRONG_2, 3, AG_WINDOW_TYPE, 3);
set_window_value(AT_USTRONG_2, 3, AG_WINDOW_LENGTH, 10);
set_window_value(AT_USTRONG_2, 3, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_USTRONG_2, 3, AG_WINDOW_ANIM_FRAME_START, 6);
set_window_value(AT_USTRONG_2, 3, AG_WINDOW_HAS_CUSTOM_FRICTION, 0);
